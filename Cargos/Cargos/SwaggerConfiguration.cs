namespace Cargos.API
{
    public class SwaggerConfiguration
    {
        public const string EndpointDescription = "Cargos API v1";
        ...
        public const string DocInfoTitle = "Cargos API";

        public const string DocInfoVersion = "v1";

        public const string DocInfoDescription = "Facturacion";
    }
}
